...
public interface IndexDataMapper {
  ...
  @Mapping(target = "versus", source = "entity.versus")
  @Mapping(target = "marketPrice", source = "entity.marketPrice")
  @Mapping(target = "tradingPrice", source = "entity.tradingPrice")
  @Mapping(target = "tradingQuantity", source = "entity.tradingQuantity")
  @Mapping(target = "indexInfoId", source = "entity.indexInfo.id")
  IndexDataDto toDto(IndexData entity);

  @Mapping(target = "tradingPrice", source = "dto.tradingPrice")
  @Mapping(target = "tradingQuantity",source = "dto.tradingQuantity")
