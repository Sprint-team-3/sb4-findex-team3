...
public class QIndexData extends EntityPathBase<IndexData> {
    ...
    public final NumberPath<Double> marketPrice = createNumber("marketPrice", Double.class);
    ...
    public final NumberPath<Integer> tradingQuantity = createNumber("tradingQuantity", Integer.class);

    //inherited
    public final DatePath<java.time.LocalDate> updatedAt = _super.updatedAt;

    public final NumberPath<Double> versus = createNumber("versus", Double.class);
