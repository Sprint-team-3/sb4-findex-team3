...
@Generated(
    ...
    date = "2025-08-05T18:01:13+0900",
    comments = "version: 1.5.3.Final, compiler: javac, environment: Java 17.0.15 (Microsoft)"
)
@Component
public class IndexDataIntegrationMapperImpl implements IndexDataIntegrationMapper {
    ...
    @Override
    public IndexDataDto toIndexDataDto(IndexData dto) {
        if ( dto == null ) {
            return null;
        }
